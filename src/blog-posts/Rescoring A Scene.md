...
Personally, I think it’s easier to draw from what worked in the scene above, to then find another scene that could match the music. I gathered up some main points that need to be in the scene we rescore. They are listed as follows (in order from most to least important):
...
Another point I’d like to add is a **sense of premonition** to the scene, but that relies on the context of the scene itself. The music will only take us halfway there. Note that these bolded points are exclusive to this rescore only. These points are not rules you have to follow.
...
videoLink: [https://www.youtube.com/embed/qLOeRmnppng]

Now, we travel to the editing bay.

<img src="/resources/images/assets/rescore-timeline.png">

The main components of extracting the dialogue from the scene and removing the soundtrack beneath, can get a little complicated, but the main gist of it is simple: the new music, is now where the old music was.

The version of the song, “Ecstasy,” that was used in The Last of Us Part II is the instrumental version of the song. I only realized after editing the entire scene, that the vocal version might work a little bit better. I had to redo all the work I had done on the previous audio track, but it paid off in the end as I was much more satisfied with the result.

<img src="/resources/images/assets/rescore-audio-levels.png">
...
<div class="video-embed" style="width=100%;" id="player">
    <div class="player">
        <iframe
            src="https://www.youtube.com/embed/q54GLhE7Rso"
            allowfullscreen
            allowtransparency
